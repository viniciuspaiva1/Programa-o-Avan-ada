                                      ...
                                      int IdInput0, int IdInput1, int IdInput2, int IdInput3)
{
  ...
  if(IdInput0>0)C.setId_inPort(IdPort, 0, IdInput0);
  if(IdInput1>0)C.setId_inPort(IdPort, 1, IdInput1);
  if(IdInput2>0)C.setId_inPort(IdPort, 2, IdInput2);
  if(IdInput3>0)C.setId_inPort(IdPort, 3, IdInput3);
